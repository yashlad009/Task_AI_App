...
public class EmailService {
    ...
    public void sendOtpEmail(String toEmail, String otp) {
        if (brevoApiKey == null || brevoApiKey.isBlank()) {
            System.err.println("❌ BREVO_API_KEY is missing. Email skipped.");
            return;
        }
        ...
        String htmlContent =
                "<html>" +
                        ...
                        "<tr><td width='20' style='color:#9d50bb;'>•</td><td>Personalized Task Dashboard</td></tr>" +
                        "<tr><td width='20' style='color:#9d50bb;'>•</td><td>Milestone Performance Tracking</td></tr>" +
                        "<tr><td width='20' style='color:#9d50bb;'>•</td><td>Real-time Admin Support Messaging</td></tr>" +
                        "</table>" +
                        "</div>" +
                        "</td>" +
                        "</tr>" +
        ...
        try {
            ...
            Map<String, Object> body = Map.of(
                    ...
                    "subject", "APMS PRO | Security Verification",
            ...
            System.err.println("❌ Brevo API dispatch error: " + e.getMessage());
        }
    }
}
